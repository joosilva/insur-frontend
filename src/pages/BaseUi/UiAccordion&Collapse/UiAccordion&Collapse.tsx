                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-secondary" id="accordionWithicon" open={'1'}>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="accordion-icon-none" id="accordionWithouticon" open={'1'}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon-plus" id="accordionWithplusicon" open={'1'}>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample1">
                                                    <button
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Accordion className="lefticon-accordion custom-accordionwithicon accordion-border-box" id="accordionlefticon" open={'1'}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon custom-accordion-border accordion-border-box accordion-success" id="accordionBordered" open={'1'}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-border-box" id="accordionnesting" open={'1'}>
                                            <AccordionItem>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xxl={6}>
                                                <Accordion className="custom-accordionwithicon accordion-fill-success" id="accordionFill" open={'1'}>
                                                    <AccordionItem>
                                            ...
                                            <Col xxl={6}>
                                                ...
                                                <Accordion className="custom-accordionwithicon accordion-flush accordion-fill-secondary" id="accordionFill2" open={'1'}>
                                                    <AccordionItem>
