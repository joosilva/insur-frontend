...
const Login = (props: any) => {
    ...
    const validation: any = useFormik({
        ...
        validationSchema: Yup.object({
            email: Yup.string().required(messageValidation),
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Insira seus dados para logar no Insur.</p>
                                        </div>
                                            ...
                                            <Form
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <div className="float-end">
                                                        <Link to="/forgot-password" className="text-muted">Esqueceu sua senha?</Link>
                                                    </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-check">
                                                    ...
                                                    <Label className="form-check-label" htmlFor="auth-remember-check">Lembrar de mim</Label>
                                                </div>
                                                ...
                                                <div className="mt-4 text-center">
                                                    <div className="signin-other-title">
                                                        <h5 className="fs-13 mb-1 title">Faça login com</h5>
                                                    </div>
                                                    <div>
                                                        <Link
                                                            to="#"
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Não possui conta? <Link to="/register" className="fw-semibold text-primary text-decoration-underline"> Cadastre-se </Link> </p>
                                </div>
